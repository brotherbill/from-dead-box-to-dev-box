...
1. When asked how you want to install PopOS!, choose **Clean Install**.
...
## 5. Confirm the clean installation

1. The installer will warn that the entire disk will be erased.
1. Confirm that you want to continue.
1. The installer will begin preparing the disk.
...
1. When the installation is complete, the installer will prompt you to restart the computer.
...
1. When the screen goes dark, remove the USB flash drive.
