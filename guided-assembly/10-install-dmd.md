...
###### C:/dev/repos/from-dead-box-to-dev-box/guided-assembly/10-install-dmd.md
...
1. The compiler used in most introductory examples and documentation.
1. The simplest compiler for a young engineer to begin with.
1. The least surprising when following the *Programming in D* book.
...
1. Under the Ubuntu / Debian section, move your mouse toward the **x86_64** button in preparation to click it.  
   As your pointer enters the button area, a small “sig” item may appear **below** the button.  
